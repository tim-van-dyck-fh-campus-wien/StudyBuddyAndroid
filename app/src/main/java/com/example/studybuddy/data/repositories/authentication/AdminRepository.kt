...
class AdminRepository constructor (
    ...
    suspend fun hideSettings(hideShowGroup: HideShowGroup) = adminApi.hideSettings(hideShowGroup)
    suspend fun deleteGroup(singleGroupId: SingleGroupId) = adminApi.deleteThisGroup(singleGroupId)
