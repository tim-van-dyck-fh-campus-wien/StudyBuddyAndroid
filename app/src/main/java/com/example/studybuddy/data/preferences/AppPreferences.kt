package com.example.studybuddy.data.preferences
...
/* A sort of persistant local storage. We use this to store our session Id to stay logged in!*/
object AppPreferences {
    ...
    fun setup(context: Context) {
        ...
        sharedPreferences = context.getSharedPreferences("StudyBudy.sharedprefs", MODE_PRIVATE)
    }

    // TODO step 4: replace these example attributes with your stored values

    var sessionId: String?
        get() = Key.SESSIONID.getString()
        set(value) = Key.SESSIONID.setString(value)


    private enum class Key {
        SESSIONID; // TODO step 3: replace these cases with your stored values keys
